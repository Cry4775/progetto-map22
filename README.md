...
Si distinguono in Room e Entity.
...
## 3 Programmazione concorrente & utilizzo dei file
I thread sono stati implementati nelle seguenti sezioni:
- Inizializzazione e caricamento del gioco
- Pannello animazione noise effect sulla GUI
- Aggiornamento della bussola nella GUI
- Engine (nel momento in cui viene inviato un comando dalla GUI)
- Attesa per il tasto INVIO durante le cutscene
- Monitor progresso del caricamento all'avvio del gioco

L'utilizzo dei file é distribuito in modo omogeneo all'interno dell'intero codice, tuttavia prenderemo in esempio il caricamento del gioco in quanto compone una parte importante sia per l'utilizzo dei thread che dei file.

### 3.1 Caricamento del gioco
